    ...
    >
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View><Text style={styles.greetingText}>Play Cricket</Text></View>
                <TouchableOpacity style={styles.notificationBtn}>
                    <MaterialCommunityIcons name="bell-outline" size={28} color="#edaf42" />
                </TouchableOpacity>
            </View>
            <Text style={styles.middleSection}>Choose your indoor cricket venue</Text>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.venueCard}>
                    <Image source={require('../../assets/cric1.jpg')}
                        style={styles.venueImage} />

                    <View style={styles.cardInfo}>
                        <View>
                            <Text style={styles.venueName}>Lords Indoor Arena</Text>
                ...
                <View style={styles.venueCard}>
                    <Image source={require('../../assets/cric2.jpg')}
                        style={styles.venueImage} />


                    <View style={styles.cardInfo}>
                        <View>
                            <Text style={styles.venueName}>Super Over Cricket</Text>
                ...
                <View style={styles.venueCard}>
                    <Image source={require('../../assets/cric3.jpg')}
                        style={styles.venueImage} />

                    <View style={styles.cardInfo}>
                        <View>
                            <Text style={styles.venueName}>Cricket Knights</Text>
...
export default CricketIndoorsList
