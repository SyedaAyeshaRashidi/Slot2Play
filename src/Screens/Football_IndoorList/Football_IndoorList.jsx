    ...
    >
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View><Text style={styles.greetingText}>Play FootBall</Text></View>
                <TouchableOpacity style={styles.notificationBtn}>
                    <MaterialCommunityIcons name="bell-outline" size={28} color="#edaf42" />
                </TouchableOpacity>
            </View>
            <Text style={styles.middleSection}>Choose your indoor football venue</Text>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.venueCard}>
                    <Image source={require('../../assets/football1.jpg')}
                        style={styles.venueImage} />

                    <View style={styles.cardInfo}>
                        <View>
                            <Text style={styles.venueName}>Goal Hub</Text>
                ...
                <View style={styles.venueCard}>
                    <Image source={require('../../assets/football2.jpg')}
                        style={styles.venueImage} />


                    <View style={styles.cardInfo}>
                        <View>
                            <Text style={styles.venueName}>Futsal Arena</Text>
                ...
                <View style={styles.venueCard}>
                    <Image source={require('../../assets/football3.jpg')}
                        style={styles.venueImage} />

                    <View style={styles.cardInfo}>
                        <View>
                            <Text style={styles.venueName}>Elite Futsal Arena</Text>
...
export default Football_IndoorList
